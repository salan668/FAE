...
class Ui_Process(object):
    def setupUi(self, Process):
        ...
        self.All = QtWidgets.QCheckBox(self.groupNormalization)
        ...
        self.checkBox = QtWidgets.QCheckBox(self.groupPreprocess)
        ...
        self.checkBox_2 = QtWidgets.QCheckBox(self.groupSelector)
        ...
        self.checkBox_3 = QtWidgets.QCheckBox(self.groupClassifier)
        ...
        self.All.clicked.connect(self.checkNormalizeUnit.click)
        self.All.clicked.connect(self.checkNormalizeZeroCenter.click)
        self.checkBox.clicked.connect(self.checkPCA.click)
        self.checkBox_2.clicked.connect(self.checkRFE.click)
        self.checkBox_2.clicked.connect(self.checkRelief.click)
        self.checkBox_3.clicked.connect(self.checkLDA.click)
        self.checkBox_3.clicked.connect(self.checkLogisticRegression.click)
        self.checkBox_3.clicked.connect(self.checkAdaboost.click)
        self.checkBox_3.clicked.connect(self.checkGaussianProcess.click)
        self.checkBox_3.clicked.connect(self.checkAE.click)
        self.checkBox_3.clicked.connect(self.checkRF.click)
        self.checkBox_3.clicked.connect(self.checkLRLasso.click)
        self.checkBox_3.clicked.connect(self.checkDecisionTree.click)
        self.checkBox_3.clicked.connect(self.checkNativeBayes.click)
    ...
    def retranslateUi(self, Process):
        ...
        self.All.setText(_translate("Process", "All"))
        ...
        self.checkBox.setText(_translate("Process", "CheckBox"))
        ...
        self.checkBox_2.setText(_translate("Process", "CheckBox"))
        ...
        self.checkBox_3.setText(_translate("Process", "CheckBox"))
