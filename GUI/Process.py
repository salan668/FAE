...
# Form implementation generated from reading ui file 'D:\MyCode\FeatureAnalysisPro\GUI\Process.ui'
#
...
class Ui_Process(object):
    ...
    def retranslateUi(self, Process):
        ...
        self.groupBox_3.setTitle(_translate("Process", "Balance Data"))
        self.radioNoneBalance.setText(_translate("Process", "None Balance"))
